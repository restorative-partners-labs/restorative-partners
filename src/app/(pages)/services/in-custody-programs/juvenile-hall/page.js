...
import bg_banner from "@/assets/images/juvenile-hall-class.jpg";
...
export const metadata = {
  title: "Restorative Partners - Juvenile Hall",
  description:
    "In partnership with Restorative Partners, the Juvenile Hall offers a myriad of programs that are designed to assist our youth towards rehabilitation.",
};
  ...
  return (
    <>
      <section className="blog-single">
        <div>
          <Image className="w-full max-h-[600px] object-cover" src={bg_banner} loading="lazy" alt="img" />
          <div className="container 2sm:mt-[156px] sm:mt-30 mt-20 pb-20">
            <div className="grid lg:grid-cols-[65%_auto] gap-[38px]">
              <div className="relative after:absolute sm:after:-left-12.5 after:-left-5 after:top-1/2 after:-translate-y-1/2 after:w-[1px] sm:after:h-[130%] after:h-[120%] after:bg-primary sm:ml-12.5 ml-5">
                ...
                <p className="text-2xl sm:text-3xl 2sm:text-4xl !leading-160 text-primary-foreground mt-[18px]">
                  In partnership with Restorative Partners, the Juvenile Hall
                  offers a myriad of programs that are designed to assist our
                  youth towards rehabilitation. Such programs include, but are
                  not limited to, art classes, chess club, Alcoholics Anonymous
                  (AA), bible study, Narcotics Anonymous (NA), yoga, tutoring,
                  Book Club, weekly church services, and a sports program.
                </p>
              </div>
