...
import bg_banner from "@/assets/images/lyonheart-place.jpg";
...
export const metadata = {
  title: "Restorative Partners - LyonHeart Place",
  ...
  return (
    <>
      <section className="blog-single">
        <div>
          <Image
            className="w-full max-h-[820px] object-cover"
            src={bg_banner}
            loading="lazy"
            alt="img"
          />
            ...
            <div className="grid lg:grid-cols-[65%_auto] gap-[38px]">
              <div className="relative after:absolute sm:after:-left-12.5 after:-left-5 after:top-1/2 after:-translate-y-1/2 after:w-[1px] sm:after:h-[130%] after:h-[120%] after:bg-primary sm:ml-12.5 ml-5">
                ...
                <p className="text-2xl sm:text-3xl 2sm:text-4xl !leading-160 text-primary-foreground mt-[18px]">
                  Restorative Partners has taken the next step in providing
                  reentry services with an eight bed home for men. This home
                  provides a safe environment for people recovering from
                  addiction and transitioning back into our community. We create
                  an environment which embodies restorative justice practices,
                  supports a clean and sober lifestyle and offers programs that
                  focus on body, mind and spiritual transformation.
                </p>
              </div>
              <div className=" bg-primary py-15 sm:px-[38px] px-5 lg:-mt-[410px]">
                <Title
                  title_text={"Rapha House"}
