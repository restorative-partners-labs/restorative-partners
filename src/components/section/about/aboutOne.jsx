...
const aboutList = [
  {
    id: "01",
    item: "Violence is not a solution to any problem",
    item_desc:
      "We thrive on challenging the norms, infusing each project with fresh, innovative perspectives that defy convention.",
  },
  {
    id: "02",
    item: "Every person is endowed with a sacred dignity",
    item_desc:
      "We thrive on challenging the norms, infusing each project with fresh, innovative perspectives that defy convention.",
  },
  {
    id: "03",
    item: "Every person is capable of changing, healing, and being restored",
    item_desc:
      "We thrive on challenging the norms, infusing each project with fresh, innovative perspectives that defy convention.",
  },
];
    ...
    <section className="pt-20">
      <div className="container-fluid ">
        <SectionTitle
          ...
          sectionTitle={"Foundations of Restorative Justice "}
          sectionDesc={
            "Transforming Lives Impacted by Crime through Healing Services & Relationships"
          }
