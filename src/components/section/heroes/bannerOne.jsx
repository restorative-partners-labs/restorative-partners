                    ...
                    <div className="xl:pt-[200px] pt-[150px] pb-[250px]">
                      <div>
                        <h1 className="xl:text-[200px] lg:text-[170px] 2sm:text-[130px] sm:text-[100px] xm:text-7xl text-5xl leading-[100%] font-extrabold relative">
                          ...
                          <svg
                            strokeWidth="2"
                            className="stroke-orange-600 stroke-dasharray-1000 stroke-dashoffset-1000 animate-text-line-animation w-full 2sm:h-[200px] h-25"
                          >
                        ...
                        <Link href={cta_link} className="mt-10 inline-block">
                          <ButtonFill
                            className={cn(
